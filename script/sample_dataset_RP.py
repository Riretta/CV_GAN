...
modelCVGAN = load_vcgan(configCVGAN, ckpt_path="logs/2022-01-11T12-53-39_imagenet_vqgan/checkpoints/Epoch_25.ckpt").to(DEVICE)
...
def reconstruction_pipeline(path, size=320):
  ...
  img = stack_reconstructions(custom_to_pil(preprocess_vqgan(x_vqgan[0])),
                              custom_to_pil(x1[0]), titles=titles)
  return img
