...
from taming.modules.diffusionmodules.model import Encoder, Decoder, PrimaryCaps, DigitCaps
...
class VQModel(pl.LightningModule):
    ...
    def encode(self, x):
        h = self.encoder(x)
        # print("ENCODING OUTPUT SIZE ->>>>>>>",h.size())
        c = self.primary(h)
        # print("Quant PRIMARY OUTPUT SIZE ->>>>>>>", c.size())
